...
<h2 style="text-align: center; margin-top: 5px;">List Kode Barang</h2>
<hr>
<div class="container">
 <div class="row">

    <div class="col-sm-4 col-md-4 mx-auto">   
        <form action="add_tipebrg.php" method="POST">
                <h4>Add Kode Barang</h4>
            <input class="form-control"  type="text" placeholder="Kode Barang" name="tipe_brg">
            <br> 
...
<br>
    ...
    <?php
        include '../connect.php';
        $no = 1;
        $list = mysqli_query($koneksi, "SELECT * from tipebarang");
        while($row = mysqli_fetch_array($list))
        {
            ...
            <td>".$row['ket']."</td>
            <td scope='col'>
            <a href='delete_tipebarang.php?tipe_barang=".$row['tipe_barang']."'><button class='btn btn-danger'>Delete</button></a></td>
        </tr>";
        $no++;
        }
    ?>
