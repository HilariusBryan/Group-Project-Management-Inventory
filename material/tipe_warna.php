...
<div class="container">
 <div class="row">
    ...
    <div class="col-sm-4 col-md-4 mx-auto">   
        <form action="add_tipewarna.php" method="POST">
                <h4>Add Kode Warna</h4>
            <input class="form-control" type="text" placeholder="Kode Warna" name="tipe_warna">
            <br> 
...
<br>
    ...
    <?php
        include '../connect.php';
        $no = 1;
        $list = mysqli_query($koneksi, "SELECT * from tipewarna");
        while($row = mysqli_fetch_array($list))
        {
            echo "<tr>
            <td>$no</td>
            <td>".$row['tipe_warna']."</td>
            <td>".$row['ket']."</td>
            <td scope='col'>
            <a href='delete_tipewarna.php?tipe_warna=".$row['tipe_warna']."'><button class='btn btn-danger'>Delete</button></a></td>
        </tr>";
        $no++;
        }
    ?>
