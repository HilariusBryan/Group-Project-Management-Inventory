...
<h2 style="text-align: center; margin-top: 5px;">List Kode Motif</h2>
<hr>
<div class="container">
<div class="row">
    ...
    <div class="col-sm-4 col-md-4 mx-auto">   
        <form action="add_tipemotif.php" method="POST">
            ...
            <input class="form-control"  type="text" placeholder="Kode Motif" name="tipe_motif">
            <br> 
 ...
 ?>
    ...
    <?php
        ...
        while($row = mysqli_fetch_array($list))
        {
            echo "<tr>
            <td>$no</td>
            <td>".$row['tipe_motif']."</td>
            <td>".$row['ket']."</td>
            <td scope='col'>
            <a href='delete_tipemotif.php?tipe_motif=".$row['tipe_motif']."'><button class='btn btn-danger'>Delete</button></a></td>
        </tr>";
        $no++;
        }
    ?>
