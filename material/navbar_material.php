  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown" id="menu4">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="tipe_barang.php">Kode Barang</a>
          <a class="dropdown-item" href="tipe_bahan.php">Kode Bahan</a>
          <a class="dropdown-item" href="tipe_motif.php">Kode Motif</a>
          <a class="dropdown-item" href="tipe_warna.php">Kode Warna</a>
      </li>
