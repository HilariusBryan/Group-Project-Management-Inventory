...
<head>
    ...
    <title>List Bahan - Marici</title>
    </head>
<body>
<?php include 'navbar_bahan.php'; ?> 

<h2 style="text-align: center; margin-top: 5px;">List Bahan</h2>
<hr>
...
<br>
 ...
 <?php
    ...
    $list = mysqli_query($koneksi, "SELECT * from bahan");
    $no = 1;
 ...
 ?>
    ...
    <?php
        ...
        {   
            ...
            <td><a href='update_bahan.php?kode_bhn=".$row['kode_bhn']."'><button class='btn btn-primary'>Edit</button></a>
            <a href='delete_bahan.php?kode_bhn=".$row['kode_bhn']."'><button class='btn btn-danger'>Delete</button></a>
            </td>
        </tr>";
        $no++;
        }
